...
COMMENT ON TABLE user_balances IS 'Tracks FLOW token balances for users in the house balance system';

-- Add comments to columns
COMMENT ON COLUMN user_balances.user_address IS 'Flow wallet address (0x...)';
COMMENT ON COLUMN user_balances.balance IS 'Current house balance in FLOW tokens (up to 8 decimal places)';
