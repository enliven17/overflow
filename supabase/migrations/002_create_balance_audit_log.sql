...
COMMENT ON COLUMN balance_audit_log.user_address IS 'Flow wallet address (0x...)';
COMMENT ON COLUMN balance_audit_log.operation_type IS 'Type of operation: deposit, withdrawal, bet_placed, bet_won, bet_lost';
COMMENT ON COLUMN balance_audit_log.amount IS 'Amount of FLOW tokens involved in the operation';
